...
-- Google Meet support + Admin for v72653666@gmail.com + Email (student_email, admin_notes)
-- ═══════════════════════════════════════════════════════════════════════
--
-- HOW TO USE:
...
-- If you already have data, use the MIGRATION section at the bottom instead.
-- ═══════════════════════════════════════════════════════════════════════
...
--
-- -- Add admin policies for v72653666@gmail.com (safe to re-run; will error if policy exists)
